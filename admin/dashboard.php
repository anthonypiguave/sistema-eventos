        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-6">
                    <?php
                    $sql = "SELECT COUNT(ID_Registrado) AS registros FROM registrados where estado_registrado = 1";
                ...
                <div class="col-lg-4 col-xs-6">
                    <?php
                    $sql = "SELECT COUNT(ID_Registrado) AS registros FROM registrados where estado_registrado = 0";
                    $resultado = $conn->query($sql);
                    $registrados = $resultado->fetch_assoc();
                    ?>
                    <!-- small box -->
                    <div class="small-box bg-blue">
                        <div class="inner">
                            <h3><?php echo $registrados['registros']; ?></h3>
                            <p>Usuarios Registrados Inactivos</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person"></i>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-6">
                    <?php
                    $sql = "SELECT COUNT(ID_Registrado) AS paypal FROM registrados where pagado = 1  and forma_pago = 'Paypal'";
                    $resultado = $conn->query($sql);
                    $registrados = $resultado->fetch_assoc();
                    ?>
                    <!-- small box -->
                    <div class="small-box bg-aqua-gradient">
                        <div class="inner">
                            <h3><?php echo $registrados['paypal']; ?></h3>
                            <p>Paypal</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-4 col-xs-6">
                    <?php
                    $sql = "SELECT COUNT(ID_Registrado) AS transfer FROM registrados where pagado = 1  and forma_pago = 'transfer'";
                    $resultado = $conn->query($sql);
                    $registrados = $resultado->fetch_assoc();
                    ?>
                    <!-- small box -->
                    <div class="small-box bg-green">
                        <div class="inner">
                            <h3><?php echo $registrados['transfer']; ?></h3>
                            <p>Transferecia o Depósito</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-bag"></i>
                        </div>
