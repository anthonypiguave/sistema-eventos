...
<?php
$conn = new mysqli('xitacademy.xenturionit.com', 'robregon', 'Pa$$w0rd.2022', 'robregon_xitacademy');
...
$fecha = date("d/m/Y");
$evento = $_POST['event_selected_id'];

header("Content-Type: text/html;charset=utf-8");
header("Content-Type: application/vnd.ms-excel charset=iso-8859-1");
$filename = "registrados al " .$fecha. ".xls";
...
$sql .= " WHERE JSON_UNQUOTE(JSON_EXTRACT(`talleres_registrados`, '$.eventos')) LIKE '%$evento%'";
