                        ...
                        <div class="box-body">
                            ...
                            <table id="registros" class="table table-bordered table-hover">
                                ...
                                try {
                                    ...
                                    $sql = "SELECT ID_admin, usuario, nombre_admin, apellido_admin, estado_admin FROM `admins` WHERE estado_admin = 1";
                                ...
                                <?php while ($admin = $resultado->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $admin['nombre_admin']; ?></td>
                                        <td><?php echo $admin['apellido_admin']; ?></td>
                                        <td>
                                            <?php
                                            $estado = $admin['estado_admin'];
                                            if($estado == 1):
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-id="<?php echo $admin['ID_admin']; ?>" data-tipo="admin"
                                               type="button" class="btn bg-maroon btn-flat margin borrar_registro"><i
