...
<!--          --><?php //endif; ?>
            ...
            <?php if($_SESSION['nivel'] == 1): ?>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="lista-admins.php"><i class="fa fa-list" aria-hidden="true"></i> Ver Todos</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="lista-cuentas.php"><i class="fa fa-list-ul"></i> Ver Todos</a></li>
                        <li><a href="nuevo-cuenta.php"><i class="fa fa-plus-circle"></i> Agregar</a></li>
                    </ul>
                </li>
            <?php endif; ?>
          <?php if($_SESSION['nivel'] == 1): ?>
