                      ...
                      <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0" value="0">
                      ...
                      <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0" value="0">
                      ...
                      <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0" value="0">
                     ...
                     <div id="resumen" class="resumen">
                        ...
                        <div class="caja clearfix">
                              <div class="extras">
                                  ...
                                  <div class="orden">
                                      <label for="regalo">Seleccione una forma de pago</label> <br>
